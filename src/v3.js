export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Flyer Repurposing Desk",
        "Operational table: Channel adaptations",
    ...
    "releaseChecklist": [
        ...
        "Fact Completeness reaches production threshold",
        "Accessibility Coverage is documented with evidence",
        "Channel Readiness has no unresolved blocker",
        "Channel copy pack verified",
        "Accessibility checklist verified",
        "Content matrix CSV verified"
    ],
    "operations": [
